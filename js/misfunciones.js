           ...
           $('#btnDetalle').click(function(){
           		...
           		if(rowsD!="")
           		{
           			...
           			for(x=1;x<=rowsD;x++)
	           		{
	           			var rowDetalle="";
	           			contador+=1;
		           		rowDetalle+='<tr id="dRow'+contador+'"><td><input type="text" name="cantidad'+contador+'"  min="1" class="form-control number" placeholder="Cantidad" size="5" onblur="importe('+contador+',1);"  required></td>';
		           		...
		           		rowDetalle+='<td><input type="text" name="pUnitario'+contador+'" min="1" class="form-control number2" placeholder="P.Unitario" size="5" onblur="importe('+contador+',1);" required></td>';
