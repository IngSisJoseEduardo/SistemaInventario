...
include_once("../php/clases/CSlogan.php");
	...
	$slogan=new CSlogan("","../php/slogan.txt");
	$tSlogan=stripslashes($slogan->contenidoSlogan());
...
foreach($_REQUEST as $indice => $contenido)
	{
		if($indice!="PHPSESSID")
		{
			...
			else if($indice=="folioasignacion")
			{
				//numero de folio
				$folioasignacion=$contenido;
			}
		}
	}
...
$nomDepto=strtoupper($regDepto['departamento']);
...
$nomEmp=strtoupper($regEmp['nombre_empleado']);
...
<table style="width: 100%;" class="header">
	<tr>
		<td><h1 style="text-align: left">Asignaciones de informatica</h1></td><td>Folio: <strong>'.$folioasignacion.'</strong></td>
...
<table style="width: 100%; font-size: 8pt;">
	...
	<tr>
		<td>Asignado por: <br><strong>'.$usuarioSis.'</strong></td>
		<td>Responsable de Equipos:<br><strong>'.$nomEmp.'</strong></td>
		<td>Departamento:<br><strong>'.$nomDepto.'</strong></td>
